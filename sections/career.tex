...
\mySubHeadingListStart
  ...
  \mySubHeading
  {DevOps Engineer}{February 2022 -- Present}
  {Jacobs Engineering - NASA}{Kennedy Space Center, FL, USA}
    \myItemListStart
      ...
      \myItem{Implemented new tools and container orchestration with Kubernetes}
      \myItem{Redesigned system architecture and fixed major issues}
    \myItemListEnd
