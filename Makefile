...
<html>
  ...
  <body style="background-color:black;">
	  <object data="./resume-jorgensen-pierce-dark.pdf" type="application/pdf" zoom="100%" width="100%" height="1500px">
      </object>
	  <object data="./resume-jorgensen-pierce.pdf" type="application/pdf" zoom="100%" width="100%" height="1500px">
      </object>
  </body>
</html>
endef
